...
const Animation = () => {
  ...
  return (
    <div className="" ref={heartRef}>
       <h1 className='font-black text-blue-400 uppercase'>animation facebook-like</h1>
         <div className="container border-2 w-72 h-96 flex justify-end items-center gap-1 relative shadow-xl shadow-cyan-400" >
            <div className="facebook absolute top-2 font-bold left-2 border-b-2 bg-gradient-to-r from-sky-700 to-indigo-600">
                <h1>Facebook</h1>
            </div>
